    ...
    <div className="space-y-6 relative">
      ...
      <div className="flex flex-wrap gap-2.5 sm:gap-3">
        <Link href="/dashboard/posts">
          <Button className="h-9 sm:h-11 text-xs sm:text-sm bg-linear-to-r from-accent-brand to-accent-dark text-white shadow-lg shadow-accent-brand/25 hover:shadow-xl hover:shadow-accent-brand/40 hover:-translate-y-0.5 transition-all duration-300 font-bold cursor-pointer rounded-lg sm:rounded-xl px-4 sm:px-6">
